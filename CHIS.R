#Download and Load haven
install.packages("haven")
library("haven", lib.loc="/Library/Frameworks/R.framework/Versions/3.3/Resources/library")

#Load CHIS data adult
adult <- read_sas("/Users/rush/Desktop/Aditya/Data Analysis/Data Visualization/chis15_adult_sas/Data/adult.sas7bdat")
